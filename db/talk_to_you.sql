...
) ENGINE = InnoDB AUTO_INCREMENT = 49 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户内容' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章点赞表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '文章浏览表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
  ...
  `avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'http://localhost:9090/file/download/default_avator.jpg' COMMENT '用户头像',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1715011999173201923 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '$2a$10$FneCjf3N6wB2opEk3tbnjevWBNcvJWj5Qwbi4goUCHFMTnvAivru2', 'example@qq.com', 'admin', 'http://localhost:9090/api/file/download/default_avator.jpg', '没有简介', '2023-11-13 18:13:09', 1, b'0');
